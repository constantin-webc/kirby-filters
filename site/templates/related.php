...
<div class="squelette">
    <aside>
        <?php snippet('filters-single/types') ?>
        <?php snippet('filters-single/supports') ?>
        <?php snippet('filters-single/years') ?>
        <?php snippet('filters-single/labels') ?>
        <?php snippet('filters-single/countries') ?>
        <?php snippet('filters-single/continents') ?>
    </aside>
