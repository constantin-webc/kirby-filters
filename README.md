# Kirby filter content in front-end

Some differents way to let the user filter categorized content

This could be a starting point for someone. Please consider I'm not a Kirby/php pro dev, 
even if it works correctly, this code may have some errors or can be better written. 

See how it works here:
<https://dev.rythmevertical.com/kirby-filters/>
